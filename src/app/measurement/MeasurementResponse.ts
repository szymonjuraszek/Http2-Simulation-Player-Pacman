export class MeasurementResponse {
  ...
  constructor(id: string, response_time_in_millis: number, specific_second_of_communication: number, version_response: number, size: number, request_timestamp: number) {
    this._id = id;
